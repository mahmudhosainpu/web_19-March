                            ...
                            <form class="space-y-4 md:space-y-6" action="#">
                                ...
                                <div>
                                    <div class="flex items-center justify-between">
                                        ...
                                        <a href="#" class="text-sm mb-2 font-medium text-primary-600 hover:underline dark:text-primary-500" style={{ "color": "#007DFA" }}>Forgot?</a>
                                    </div>
                                ...
                                <button type="submit" class="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-2 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-3 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800" style={{ "background": "#007DFA" }}>Sign in</button>
                                <button type="submit" class="w-full flex justify-center text-white bg-primary-600 hover:bg-primary-700 focus:ring-2 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-3 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800" style={{ "background": "#E0EFFE","color":"#007DFA" }}>
